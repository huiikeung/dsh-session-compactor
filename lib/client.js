window.__ModuleLoader__.load({ id: "@dsh-external/dsh-context-compactor", factory: (require) => {
  var module = { exports: {} };
...
function CompactDock(props) {
  ...
  }, [props.compact, session.running, showFeedback])
  ...
  }, [props.enhance, props.input, props.inputActions, showFeedback])
...
function CompactSettingsCard(props) {
  ...
  const snap = React.useSyncExternalStore(scope.subscribe, scope.getSnapshot)
